            ...
            <div class="content">
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        // Check if 'phone' column exists in the database and is populated
                        if(isset($row['phone'])) {
                        ...
                        // Check if 'mother' column exists in the database and is populated
                        if(isset($row['mother'])) {
                        ...
                        // Check if 'dob' column exists in the database and is populated
                        if(isset($row['dob'])) {
