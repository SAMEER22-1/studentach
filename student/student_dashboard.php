    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="notice">
                ...
                <div>
                    <marquee class="marquee" direction="left" behavior="scroll" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();" onclick="window.location.href='../Achieve/main.php';">New achievements can be viewed here.</marquee>
                </div>
            </div> 
        </div>
    </div>
